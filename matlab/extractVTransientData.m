function [dataStructure, fnames] = extractVTransientData(relPath)
%[dataStructure] = extractCVData(relPath)
% Extracts Voltage transients data from Gamry data files
...
% Outpus:
%       dataStructure: time, Voltage and current data in dataStructure
