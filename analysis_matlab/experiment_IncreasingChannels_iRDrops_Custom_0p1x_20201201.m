...
V_parallelE = customStructure_0p1(1).Vpp_sig_rec(:,5) - ...
              customStructure_0p1(2).Vpp_sig_rec(:,5);
...
for ii = 1:4
    ...
    V_predicted(:,ii) = customStructure_0p1(1).Vpp_sig_rec(:,5) - ...
...
for ii = 1:4
    ...
    'Color', colorArray( ii, : ))
    hold on
    plot(customStructure_0p1(ii+1).Vpp_sig_rec(:,5), ...
    'Color', colorArray( ii, : ))
end
