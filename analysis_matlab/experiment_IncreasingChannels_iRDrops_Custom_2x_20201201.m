...
V_parallelE = customStructure_2(1).Vpp_sig_rec(:,5) - ...
              customStructure_2(2).Vpp_sig_rec(:,5);
...
for ii = 1:4
    ...
    V_predicted(:,ii) = customStructure_2(1).Vpp_sig_rec(:,5) - ...
...
for ii = 1:4
    ...
    'Color', colorArray( ii, : ))
    hold on
    plot(customStructure_2(ii+1).Vpp_sig_rec(:,5), ...
    'Color', colorArray( ii, : ))
end
